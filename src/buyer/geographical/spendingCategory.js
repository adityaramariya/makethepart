                ...
                <div className="f-table">
                  <div className="f-row">
                    ...
                    <div className="th-f">Sub Category</div>
                     <div className="th-f">Sub SubCategoryccccccccccc</div>
...
<div class="f-tbody">
    ...
    <div class="flex checkboxesWrapper--flex">

         <div className="flex-1 flex">
                        <div className="lg-column gray-card p-10">
                          <h4 className="text-uppercase ex-titel">
                            New (to-be)
                          </h4>

                          <div className="tree o-dot">
                            <ul>
                              <li className="root">Project 1</li>
                        
                              <li>
                                <input
                                  type="checkbox"
                                  checked={this.state.grp2}
                                  id="d2"
                                  onClick={this.handleGrp2}
                                />
                                <label for="d2" class="tree_label">
                                  Group 2
                                </label>
                                ...
                                <ul>
                                    ...
                                    <span>
                                      ...
                                      <i className="more-dd">
                                        ...
                                        >
                                          <p className="btnWrap">
                                            <button
                                              className="btn btn-info sm-btn"
                                              onClick={this.handleReplaceShow}
                                            >
                                              Replace
                                            </button>
                                  ...
                                  <li>
                                    <span>Sub Group 2</span>
                                  </li>
                                  <li>
                                    <input
                                      type="checkbox"
                                      checked={this.state.subgrp}
                                      id="d4"
                                      onClick={this.handleSubGrp}
                                    />
                                    <label for="d4" class="tree_label">
                                      Sub Group 3
                                    </label>
                                    <ul>
                                      <li>
                                        <span>Sub sub Group 1</span>
                                      </li>
                                      <li>
                                        <input
                                          type="checkbox"
                                          checked={this.state.subSubgrp}
                                          id="f4"
                                          onClick={this.handleSubSubGrp}
                                        />
                                        <label for="f4" class="tree_label">
                                          Sub sub Group 2
                                        </label>
                                        <ul>
                                          <li>
