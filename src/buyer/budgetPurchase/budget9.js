...
class budget9 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tabKey: "eleven",
    ...
    return (
      <div>
        ...
        {this.state.tabKey === "eleven" ? (
            ...
            <div className="content">
              <div className="container-fluid">
                <div className="flex justify-space-between align-center">
                  <h4 className="hero-title">Price Break</h4>

                </div>

       
                 <div className="p-20 m-b-20 row m-l-0 m-r-0">
                        <h5>Supplier:-</h5>
                       <Col sm={4}>
                        <Table className="custom-table no-border-table">
                        <tbody>
                          <tr>
                            <td className="color-light w-175">Blanket/ Planned Purchase Order: </td>
                            <td>Nill</td>
                          </tr>
                          <tr>
                        ...
                        <Col sm={4}>
                         <Table className="custom-table no-border-table">
                          <tbody>
                            <tr>
                              <td className="color-light w-175">Total Volume:</td>
                              <td>Nill</td>
                            </tr>
                            <tr>
                              <td className="color-light w-175">
                               Order Period Valid from:
                              </td>
                              <td>Nill</td>
                            </tr>
                            <tr>
                              <td className="color-light w-175">
                                 Order Period Valid Through:
                              </td>
                              <td>Nill</td>
                            </tr>
             ...
             <div className="flex w400">
          
                <div className="totalCounting">
                 <p>Total</p>
               </div>
               <div className="m-b-15">
                  <Table
                    ...
                    bordered
                    condensed
                    className="custom-table cell-input out-calander m-b-0"
                  >
                    <thead>
                      <tr>
          ...
          <h4 className="hero-title">Delivery Schedule</h4>   
            <div className="flex w400">
               ...
               <div className="m-b-15">
                ...
                <div className="text-center m-b-15 w400">
                  <button
