...
import { Popover, Table, FormControl, FormGroup, Modal ,InputGroup, Glyphicon, Row,
...
class budget8 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tabKey: "eleven",
            ...
            <div className="content">
              <div className="container-fluid">
                <div className="flex justify-space-between align-center">
                  <h4 className="hero-title">Blanket/ Planned Purchase Agreement</h4>

                  <div className="flex">
                    <FormGroup className="w160">
                      <InputGroup>
                        <FormControl type="text" placeholder="Supplier Code" />
                        <InputGroup.Addon>
                          <Glyphicon glyph="search" />
                        </InputGroup.Addon>
                      </InputGroup>
                    </FormGroup>
                     <FormGroup className="w160 m-l-10">
                      <InputGroup>
                        <FormControl type="text" placeholder="Supplier Name" />
                        <InputGroup.Addon>
                          <Glyphicon glyph="search" />
                        </InputGroup.Addon>
                      </InputGroup>
                 ...
                 <div className="p-20 m-b-20 border-light border-around row m-l-0 m-r-0">
                        <h5>Supplier:-</h5>
                       <Col sm={4}>
                        <Table className="custom-table no-border-table">
                        <tbody>
                          <tr>
                            <td className="color-light w-175">Supplier Company Name:</td>
                            <td>Nill</td>
                          </tr>
                          <tr>
                        ...
                        <Col sm={4}>
                         <Table className="custom-table no-border-table">
                          <tbody>
                            <tr>
                              <td className="color-light w-175">My Company:</td>
                              <td>Nill</td>
                            </tr>
                            <tr>
                              <td className="color-light w-175">
                ...
                <div className="m-b-15">
                  ...
                  >
                    <thead>
                      <tr>
                        <th></th>
                        <th>Blanket Purchase Agreement ID</th>
                        <th>Part No.</th>
                        <th>Part Description</th>
                        <th>Project Code <br/>(Reference)</th>
                        <th>Currency</th>
                        <th>Unit Price</th>
                        <th>Allow Price Revisions <br/> (Max Unit Price)</th>
                        <th>UOM</th>
                        <th>Blanket Order Period <br/> (Valid From)</th>
                        <th>Blanket Order Value <br/> (Valid Through)</th>
                        <th>Minimum Order Quantity</th>
                        <th>Minimum Order Value</th>
                        <th>Frequency/Delivery Schedule</th>
                        <th>Lead Time on Delivery <br/>(After Blanket Release)</th>
                        <th>Minimum Total Quantity <br/> (Blanket Period)</th>
                        <th>Minimum Total Value <br/> (Blanket Period Optional)</th>
                        <th>Price Break</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                         <td>
                                ...
                                <ul>
                                  <li>
                                    <input
                                      type="checkbox"
                                      id="c6"/>
                                    <label for="c6" class="checkclick_label">
                                      Monthly
                                    </label>
                            ...
                            <td>
                               <FormGroup className="m-b-0">
                                <FormControl
                                  ...
                                  className="br-0 "
                                  name="itemDescription"
                                  placeholder="Minimum Total Quantity"
                          ...
                          <td>  <span className="ico-action-sm w50">
                                        <svg>
                                          <use
              ...
              <div className="w400 termsCondition m-t-20">
                 <p className="color-light">Terms</p>
                      <p
                        className="terms-pt flex align-center"   
                      >
                        <span>1.</span>
                         <FormGroup className="selectterms" controlId="formControlsSelect">
                            <FormControl
                              componentClass="select"
                              placeholder="select"
                              className="s-arrow br-0"
                      ...
                      >
                        ...
                        <FormControl
                          type="text"
                          name="term" placeholder="Blanket Agreement valid through the blanket order period from date of release"
                        />
                      </p>
                      <p
                        className="terms-pt flex align-center"
                      ...
                      >
                        ...
                        <FormControl
                          type="text"
                          name="term" placeholder="Logistics"
                        />
                      </p>
