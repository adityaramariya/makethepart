...
import budget1 from './budgetPurchase/budget1';
import budget2 from './budgetPurchase/budget2';
import budget3 from './budgetPurchase/budget3';
  ...
  render() {
    return (
      <Switch>
        ...
        <Route
          exact
          path={`${this.props.match.path}/budget1`}
          component={budget1}
        />
        <Route
          exact
          path={`${this.props.match.path}/budget2`}
          component={budget2}
        />
        <Route
          exact
          path={`${this.props.match.path}/budget3`}
          component={budget3}
        />
        <Route
          exact
