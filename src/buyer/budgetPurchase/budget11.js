...
class budget11 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tabKey: "eleven",
            ...
            <div className="content">
              <div className="container-fluid">
                <div className="flex justify-space-between align-center">
                  <h4 className="hero-title">Standard Purchase Order</h4>
