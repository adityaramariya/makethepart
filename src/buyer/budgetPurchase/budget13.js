...
class budget13 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tabKey: "eleven",
            ...
            <div className="content">
              <div className="container-fluid">
                <div className="flex justify-space-between align-center">
                  <h4 className="hero-title">Blanket Pos coming up for Renewal</h4>
                  ...
                  <div class="groupRadio">
                         ...
                         <label className="label--radio">
                                <input
                                  type="radio"
                                  className="radio" name="m-radio" value="aa"/> Group by the Supplier
                         
                           </label>
                           <label className="label--radio">
                                <input
                                  type="radio"
                                  className="radio" name="m-radio" value="aa"/> Next 30 days
                         
                           </label> 
                           <label className="label--radio">
                                <input
                                  type="radio"
                                  className="radio" name="m-radio" value="aa"/> Next 60 days
                  ...
                  >
                    <thead>
                      <tr>
                        ...
                        <th>Project Code</th>
                        <th>Where Used</th>
                        <th>PO Valid Through</th>
                        <th>Total Quantity Agreed</th>
                        <th>Quantity Order till date</th>
                        <th>Share of business</th>
                        <th>Alternate <br/>Supllier 1 <br/> SOB</th>
                        <th>Alternate <br/>Supllier 2 <br/> SOB</th>
                         <th>Alternate <br/>Supllier 3 <br/> SOB</th>
                        <th>Alternate <br/> Supllier 4 <br/> SOB</th>
                        <th>Renew on Current terms</th>
                        <th>Reevaluate/<br/> RFQ</th>
                      </tr>
                    </thead>
                    <tbody>
